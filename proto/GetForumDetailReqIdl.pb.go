...
var file_GetForumDetailReqIdl_proto_rawDesc = []byte{
	...
	,
}

var (
	file_GetForumDetailReqIdl_proto_rawDescOnce sync.Once
	file_GetForumDetailReqIdl_proto_rawDescData = file_GetForumDetailReqIdl_proto_rawDesc
)

func file_GetForumDetailReqIdl_proto_rawDescGZIP() []byte {
	file_GetForumDetailReqIdl_proto_rawDescOnce.Do(func() {
		file_GetForumDetailReqIdl_proto_rawDescData = protoimpl.X.CompressGZIP(file_GetForumDetailReqIdl_proto_rawDescData)
	})
...
var file_GetForumDetailReqIdl_proto_goTypes = []interface{}{
...
func file_GetForumDetailReqIdl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_GetForumDetailReqIdl_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetForumDetailReqIdl); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_GetForumDetailReqIdl_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetForumDetailReqIdl_DataReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_GetForumDetailReqIdl_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_GetForumDetailReqIdl_proto_rawDesc = nil
