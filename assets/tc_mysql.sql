...
--
-- 表的索引 `tc_ver4_ban_userset`
--
ALTER TABLE `tc_ver4_ban_userset`
  ADD UNIQUE KEY `uid` (`uid`);

--
-- 表的索引 `tc_ver4_rank_log`
--
...
--
-- 使用表AUTO_INCREMENT `tc_baiduid`
--
ALTER TABLE `tc_baiduid`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `tc_kd_growth`
--
ALTER TABLE `tc_kd_growth`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `tc_tieba`
--
ALTER TABLE `tc_tieba`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `tc_users`
--
ALTER TABLE `tc_users`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `tc_ver4_ban_list`
--
ALTER TABLE `tc_ver4_ban_list`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `tc_ver4_rank_log`
--
ALTER TABLE `tc_ver4_rank_log`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
COMMIT;
